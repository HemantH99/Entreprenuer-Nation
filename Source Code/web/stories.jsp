  ...
  <nav class="maroon" role="navigation">
   <!--<div class="nav-wrapper container">-->
	  ...
	  <ul class="right hide-on-med-and-down">
		...
		<li class="active"> <a href="stories.jsp">Stories</a></li>
		<li><a href="events.html">Events</a></li>
		<li><a href="states.html">States</a></li>
		<li><a href="#">Contact</a></li>
		<li class=" teal lighten-2"> <form class="right" name="vinform">
        <div class="input-field">
          <i class="material-icons prefix">search</i>
          <input type="text" id="icon_prefix" name="name" class="validate" onkeyup="searchInfo()" />
          <label for="icon_prefix" class="white-text">Search</label>
        </div>
